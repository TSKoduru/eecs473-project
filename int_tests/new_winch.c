...
#define PWM_DECEL_UP 1300   // strongest braking / holding torque
...
// Slight upward torque → constant-speed descent (tune 1450–1490)
void pwm_constant_descent() {
	...
	while (1) {
		switch (current_state) {
			...
			case DOWN_FREE_FALL:
				...
				pwm_free_fall();
				HAL_Delay(2000);
				current_state = DOWN_CONSTANT;
				break;

			case DOWN_CONSTANT:
				pwm_constant_descent();       // maintain constant speed
				break;
